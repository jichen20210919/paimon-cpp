...
TEST(SpecialFieldsTest, SequenceNumberField) {
...
TEST(SpecialFieldsTest, ValueKindField) {
...
TEST(SpecialFieldsTest, RowIdField) {
...
TEST(SpecialFieldsTest, KeyValueSpecialFieldCount) {
    ASSERT_EQ(SpecialFields::KEY_VALUE_SPECIAL_FIELD_COUNT, 2);
}

TEST(SpecialFieldsTest, IsSpecialFieldName) {
